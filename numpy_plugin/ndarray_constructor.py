...
def ndarray_constructor(funcname: str,
    ...
    if is_ndsequence_of_ints(arg_typ):
        return [ctx.api.named_type('builtins.int'), ndsequence_dim_as_int(arg_typ)]
    if is_ndsequence_of_bool(arg_typ):
        return [ctx.api.named_type('builtins.bool'), ndsequence_dim_as_int(arg_typ)]
    if is_ndsequence_of_float(arg_typ):
        return [ctx.api.named_type('builtins.float'), ndsequence_dim_as_int(arg_typ)]
