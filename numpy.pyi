...
AxesType = Union[int, Tuple[int, ...], _AxisTypeSingleton]
OrderType = Union[str, Sequence[str]]
DtypeType = Union[dtype, type, str, _DtypeTypeSingleton]

_IndexType = Union[int, List[int], slice, None, 'ndarray[int, Any]', 'ndarray[bool, Any]',]
...
class ndarray(Generic[_S, _D], SupportsAbs['ndarray[_S, _D]'], Sized, Iterable):
    ...
    # Incomplete
    def all(self, axis: AxesType=None, keepdims: bool=False) -> 'ndarray[bool, _InferNdims]': ...
...
def zeros(shape: ShapeType, dtype: DtypeType=float, order: str='C') -> ndarray[_InferDtypeWithDefault[float], _InferNdims]: ...
def ones(shape: ShapeType, dtype: DtypeType=float, order: str='C') -> ndarray[_InferDtypeWithDefault[float], Any]: ...
def empty(shape: ShapeType, dtype: DtypeType=float, order: str='C') -> ndarray[_InferDtypeWithDefault[float], Any]: ...
def full(shape: ShapeType, fill_value: scalar, dtype: DtypeType=float, order: str='C') -> ndarray[_InferDtypeWithDefault[float], Any]: ...
